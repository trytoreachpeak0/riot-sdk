...
/// <summary>
/// Seam: Facade CancelOrder via task command CMD_ORDER_CANCEL (BC-ORDER-003).
/// Known-good success body from Lab fixture EC-cancel-executing-success.
/// </summary>
public class CancelOrderFacadeTests
{
    private const string OrderId = "order-2079062513265278976";
    ...
    [Fact]
    public async Task CancelOrder_succeeds_without_throwing()
    {
        ...
        await session.Tasks.CancelOrderAsync(OrderId);
    }
