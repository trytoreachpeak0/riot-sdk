...
@dataclass
class Page_Of_u5347u7ea7u4efbu52a1u8fd4u56deObject(AdditionalDataHolder, Parsable):
    ...
    records: Optional[list[U5347u7ea7u4efbu52a1u8fd4u56deObject]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Page_Of_u5347u7ea7u4efbu52a1u8fd4u56deObject:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Page_Of_u5347u7ea7u4efbu52a1u8fd4u56deObject
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Page_Of_u5347u7ea7u4efbu52a1u8fd4u56deObject()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "records": lambda n : setattr(self, 'records', n.get_collection_of_object_values(U5347u7ea7u4efbu52a1u8fd4u56deObject)),
