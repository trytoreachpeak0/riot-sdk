...
@dataclass
class ResponseMsg_Of_DumpData(AdditionalDataHolder, Parsable):
    ...
    # The result property
    result: Optional[DumpData] = None
    # The tid property
    tid: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ResponseMsg_Of_DumpData:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ResponseMsg_Of_DumpData
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ResponseMsg_Of_DumpData()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "result": lambda n : setattr(self, 'result', n.get_object_value(DumpData)),
