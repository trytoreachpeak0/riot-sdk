...
class DeleteRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/task/v1/parkConfig/delete
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/task/v1/parkConfig/delete", path_parameters)
    
    def by_id(self,id: int) -> DeleteItemRequestBuilder:
        """
        Gets an item from the riot_sdk.generated.task.api.task.v1.parkConfig.delete.item collection
        param id: id
