...
class CommandRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/task/v1/order/command
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/task/v1/order/command", path_parameters)
    
    def by_order_key(self,order_key: str) -> WithOrderKeyItemRequestBuilder:
        """
        Gets an item from the riot_sdk.generated.task.api.task.v1.order.command.item collection
