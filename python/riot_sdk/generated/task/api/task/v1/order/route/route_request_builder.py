...
class RouteRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/task/v1/order/route
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/task/v1/order/route", path_parameters)
    
    def by_vehicle_key(self,vehicle_key: str) -> WithVehicleKeyItemRequestBuilder:
        """
        Gets an item from the riot_sdk.generated.task.api.task.v1.order.route.item collection
