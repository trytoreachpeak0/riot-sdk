...
class EditRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/task/v1/order/edit
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/task/v1/order/edit", path_parameters)
    ...
    def with_url(self,raw_url: str) -> EditRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: EditRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return EditRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class EditRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
