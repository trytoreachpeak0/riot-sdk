...
class DownLoadRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/task/v1/agvLog/downLoad
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/task/v1/agvLog/downLoad?deviceKey={deviceKey}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[DownLoadRequestBuilderGetQueryParameters]] = None) -> Optional[ResponseMsg]:
        """
        导出agv日志
