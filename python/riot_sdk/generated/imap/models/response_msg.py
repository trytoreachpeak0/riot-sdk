...
if TYPE_CHECKING:
    from .response_msg_result import ResponseMsg_result

@dataclass
class ResponseMsg(AdditionalDataHolder, Parsable):
    ...
    # The result property
    result: Optional[ResponseMsg_result] = None
    # The tid property
    tid: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ResponseMsg:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "result": lambda n : setattr(self, 'result', n.get_object_value(ResponseMsg_result)),
