...
if TYPE_CHECKING:
    from .....models.map_removed_resource import MapRemovedResource
...
class EmptyPathSegmentRequestBuilder(BaseRequestBuilder):
    ...
    async def put(self,body: MapRemovedResource, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ResponseMsg]:
        """
        编辑资源
    ...
    def to_put_request_information(self,body: MapRemovedResource, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        编辑资源
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
