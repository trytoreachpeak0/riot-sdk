...
class StationsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/imap/v1/mapInfo/stations
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/imap/v1/mapInfo/stations", path_parameters)
    
    def by_map_id(self,map_id: int) -> WithMapItemRequestBuilder:
        """
        Gets an item from the riot_sdk.generated.imap.api.imap.v1.mapInfo.stations.item collection
        param map_id: 地图id
