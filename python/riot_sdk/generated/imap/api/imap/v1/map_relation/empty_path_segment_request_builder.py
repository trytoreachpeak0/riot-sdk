...
if TYPE_CHECKING:
    from .....models.map_relationship_object import MapRelationshipObject
...
class EmptyPathSegmentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/imap/v1/mapRelation/{?keyword*,order*,orderBy*,pageNum*,pageSize*}", path_parameters)
    ...
    async def post(self,body: MapRelationshipObject, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ResponseMsg]:
        """
        新增地图关系
        param body: 多地图关系表
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    async def put(self,body: MapRelationshipObject, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ResponseMsg]:
        """
        修改地图关系
        param body: 多地图关系表
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: MapRelationshipObject, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        新增地图关系
        param body: 多地图关系表
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_put_request_information(self,body: MapRelationshipObject, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        修改地图关系
        param body: 多地图关系表
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
