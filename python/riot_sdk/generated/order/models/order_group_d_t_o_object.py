...
@dataclass
class OrderGroupDTOObject(AdditionalDataHolder, Parsable):
    """
    添加订单－根据订单组合生成订单类
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OrderGroupDTOObject:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: OrderGroupDTOObject
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return OrderGroupDTOObject()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "orderGroupId": lambda n : setattr(self, 'order_group_id', n.get_int_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_int_value("orderGroupId", self.order_group_id)
