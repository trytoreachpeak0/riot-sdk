...
if TYPE_CHECKING:
    from .update_mission_extend_params import UpdateMission_extendParams

@dataclass
class UpdateMission(AdditionalDataHolder, Parsable):
    ...
    # 扩展参数
    extend_params: Optional[UpdateMission_extendParams] = None
    # 动作子任务执行失败的策略
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> UpdateMission:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: UpdateMission
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "extendParams": lambda n : setattr(self, 'extend_params', n.get_object_value(UpdateMission_extendParams)),
