...
class MissionDTO(AdditionalDataHolder, Parsable):
    ...
    # 工作站点标识
    station_identify: Optional[str] = None
    # 动作子任务执行成功的策略
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "stationIdentify": lambda n : setattr(self, 'station_identify', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("stationIdentify", self.station_identify)
