...
if TYPE_CHECKING:
    from .order_sub_statistics import OrderSubStatistics

@dataclass
class OrderStatistics(AdditionalDataHolder, Parsable):
    ...
    # The orderSubStatistics property
    order_sub_statistics: Optional[list[OrderSubStatistics]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OrderStatistics:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "orderSubStatistics": lambda n : setattr(self, 'order_sub_statistics', n.get_collection_of_object_values(OrderSubStatistics)),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_collection_of_object_values("orderSubStatistics", self.order_sub_statistics)
