...
@dataclass
class OpcService(AdditionalDataHolder, Parsable):
    ...
    input_data: Optional[list[OpcParameter]] = None
    # The outputData property
    output_data: Optional[list[OpcParameter]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OpcService:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "inputData": lambda n : setattr(self, 'input_data', n.get_collection_of_object_values(OpcParameter)),
