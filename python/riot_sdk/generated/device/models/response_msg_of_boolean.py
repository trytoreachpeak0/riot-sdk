...
@dataclass
class ResponseMsg_Of_boolean(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ResponseMsg_Of_boolean:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ResponseMsg_Of_boolean
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ResponseMsg_Of_boolean()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "result": lambda n : setattr(self, 'result', n.get_bool_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("result", self.result)
