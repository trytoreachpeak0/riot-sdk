...
@dataclass
class U8f66u8f86u67e5u8be2u8bf7u6c42Object(AdditionalDataHolder, Parsable):
    """
    车辆查询请求对象
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> U8f66u8f86u67e5u8be2u8bf7u6c42Object:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: U8f66u8f86u67e5u8be2u8bf7u6c42Object
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return U8f66u8f86u67e5u8be2u8bf7u6c42Object()
