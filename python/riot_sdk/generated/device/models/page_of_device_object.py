...
@dataclass
class Page_Of_DeviceObject(AdditionalDataHolder, Parsable):
    ...
    records: Optional[list[DeviceObject]] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Page_Of_DeviceObject:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Page_Of_DeviceObject
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Page_Of_DeviceObject()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "records": lambda n : setattr(self, 'records', n.get_collection_of_object_values(DeviceObject)),
