...
class UnbindRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/device/v1/devices/unbind", path_parameters)
    
    def by_device_key(self,device_key: str) -> WithDeviceKeyItemRequestBuilder:
        """
        Gets an item from the riot_sdk.generated.device.api.device.v1.devices.unbind.item collection
