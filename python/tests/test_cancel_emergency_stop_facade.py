...
_CANCEL_SUCCESS_BODY = (
    ...
    '"fType":"SERVICE_CALL_REPLY","id":"461003","timestamp":1784534968901},"tid":""}'
)


@pytest.mark.asyncio
async def test_cancel_emergency_stop_succeeds_without_throwing() -> None:
    ...
    async with httpx.AsyncClient(
        ...
        async with RiotSession(options, client=client) as session:
            await session.device.cancel_emergency_stop(_DEVICE_KEY)
